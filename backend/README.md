...
## Project Structure
    ...
    ├── tst_double_mod_opt__22913  # Django project configurations
...
1. Clone this repo and `cd tst_double_mod_opt__22913`
...
2. Clone this repo and `cd tst_double_mod_opt__22913`
